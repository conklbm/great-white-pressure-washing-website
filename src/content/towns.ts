  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "A milder version. Foley sits far enough inland that salt isn't the daily issue it is in Gulf Shores, but south winds do carry some. The bigger local drivers are humidity, shade, and new-construction staining — all squarely in our wheelhouse.",
      },
    ],
  },
  {
    ...
    name: "Gulf Shores",
    county: "Baldwin",
    h1: "Pressure Washing in Gulf Shores, AL",
    metaTitle: "Gulf Shores AL Pressure Washing & Salt Removal | Great White",
    metaDescription:
      "Pressure washing in Gulf Shores, AL — salt-film removal, house washing, and rental turnover cleaning from Fort Morgan Road to the canal homes. Free quotes.",
    card: "Sand, salt, and rental season — beach homes, canal properties, and Fort Morgan Road on our route.",
    intro: [
      "Everything in Gulf Shores lives in salt air. It drifts in off the Gulf, settles on siding and windows as a dull film, corrodes fixtures, and feeds a special coastal mix of grime that inland homes never see. Between the salt, the sun, and the sand, beach properties age faster than they should — unless someone washes the coast off them regularly.",
      "That someone is us. Great White cleans beach houses off Fort Morgan Road, canal-front homes along the Intracoastal, and year-round residences in the neighborhoods behind the beach. For rental owners and property managers, we time exterior cleanings between guest turnovers, because a listing photo with a bright house and clean deck earns more bookings than a dingy one.",
    ],
    local: {
      heading: "What salt air does — and what we do about it",
      body: [
        "Salt is sneaky. It doesn't look like much day to day, but it builds a hazy film on siding and glass, holds moisture against every surface, and speeds up rust on railings, fixtures, and fasteners — which then bleed orange streaks down the walls. A proper coastal house wash strips the salt film and the grime with it, and our rust treatments erase the streaks the fixtures left behind.",
        "Rental properties have their own clock. Down here the exterior is part of the product: guests judge the house from the driveway, and reviews mention it. We work with owners and managers on schedules that fit the season — a deep clean before spring bookings open, touch-ups between peak weeks, and a post-season wash before winter.",
        "Canal and lagoon homes near Little Lagoon and the Intracoastal add still water and boat traffic to the mix, which means algae on seawall-side concrete, docks, and shaded siding. Wood decks and walkovers get careful low-pressure cleaning so the grain doesn't fur up — the beach is hard enough on wood without us adding to it.",
      ],
    },
    landmarks: ["Fort Morgan Road", "Gulf State Park", "The Hangout", "Little Lagoon", "Waterway Village", "Canal Road"],
    faqs: [
      {
        q: "How often should a Gulf Shores home be washed?",
        a: "More often than inland. Salt film builds continuously, so most beach-area homes look and last their best washed every six to twelve months. Rental properties usually anchor to the season: a deep clean before spring, then as needed through summer.",
      },
      {
        q: "Can you clean between guest checkouts for a rental?",
        a: "Yes — that's a big part of our Gulf Shores work. Give us the turnover window and we'll have the exterior, deck, and walkways done before the next check-in. Managers with multiple properties can set a standing schedule.",
      },
      {
        q: "There are orange streaks running down from our light fixtures and railings. What is that?",
        a: "Rust. Salt air corrodes metal fast, and rain carries the oxidation down the wall. A standard wash won't remove it, but our rust-stain treatment will — and cleaning it early keeps the streak from etching into the surface.",
      },
    ],
  },
  {
    ...
    name: "Orange Beach",
    county: "Baldwin",
    h1: "Pressure Washing in Orange Beach, AL",
    metaTitle: "Orange Beach AL Pressure Washing & Soft Wash | Great White",
    metaDescription:
      "Pressure washing in Orange Beach, AL — soft washing for beach homes, salt and rust removal, and commercial cleaning near The Wharf and Perdido Beach Blvd.",
    card: "Salt spray country — upscale beach homes, marinas, and commercial properties from The Wharf to Alabama Point.",
    intro: [
      "Orange Beach sits closer to open water than anywhere else we serve — Gulf on one side, back bays and marinas on the other. Salt spray reaches everything here, from the beach homes off Perdido Beach Boulevard to the shops and restaurants at The Wharf. If the Gulf Coast has a front line in the fight against grime, this is it — and Great White likes its odds.",
      "We clean the properties that make Orange Beach look the part: upscale homes around Cotton Bayou, Terry Cove, and Ono Island, and the commercial spaces that host a few million visitors a year. Soft washing for stucco, vinyl, and painted exteriors; surface cleaning for pool decks and driveways; and salt and rust removal everywhere the spray lands.",
    ],
    local: {
      heading: "Two waterfronts' worth of salt",
      body: [
        "Beachfront homes take the Gulf's spray head-on, but the bay side doesn't get a pass — marina neighborhoods around Terry Cove and Cotton Bayou collect salt haze, dock algae, and the fine grime that boat traffic kicks up. Either way the answer is a thorough soft wash that dissolves the salt film rather than grinding it in, followed by a fresh-water rinse of everything we touched.",
        "The finishes here deserve respect. Orange Beach homes lean toward stucco, painted hardboard, and high-end trim, and pool decks are often textured or tiled surfaces that high pressure would scar. We match the method to the material — low pressure and the right solution on walls, measured surface cleaning on decks and drives — so the house gets clean and stays flawless.",
        "On the commercial side, we serve restaurants, shops, and offices from The Wharf to the Perdido Beach Boulevard strip: sidewalks, entrances, patios, and parking areas, cleaned on schedules built around tourist traffic. Early mornings are our specialty — done and gone before the first customers arrive.",
      ],
    },
    landmarks: ["Perdido Beach Boulevard", "The Wharf", "Cotton Bayou", "Terry Cove", "Ono Island", "Alabama Point"],
    faqs: [
      {
        q: "Does salt really need to be washed off, or does rain handle it?",
        a: "Rain helps the day it falls, but it doesn't stop the buildup. Salt film keeps forming between rains, holds moisture on the surface, and quietly corrodes fixtures and fasteners. Regular washing is what actually protects a coastal exterior — most Orange Beach properties do best on a six-to-twelve-month cycle.",
      },
      {
        q: "Can you clean a stucco home without damaging it?",
        a: "Yes. Stucco should never see high pressure — it can crack and wick water into the wall. We soft wash it: gentle pressure, a solution that kills the growth and lifts the salt, and a careful rinse. The texture stays perfect.",
      },
      {
        q: "Do you take on commercial properties in Orange Beach?",
        a: "We do — storefronts, restaurant patios, sidewalks, and entrances around The Wharf, Perdido Beach Boulevard, and the marinas. We'll build the schedule around your busy season and work hours that don't cost you customers.",
      },
    ],
  },
];
